...
public:
    ...
    float RESULT_SCALE = 0.1; // 画像投影点の内どれくらいの距離の点を接地点とみなすか
    ...
    int PLANE_WIDTH = 200;
    int POINT_DIST = 10;
    float TARGET_AREA_WIDTH = 2; //m
    float TARGET_AREA_HEIGHT = 1; //m
    bool SHOW_TRAJECTORY = false;
    bool PLOT_ON_WARPED_IMAGE = false;
    bool USE_WEBCAM = false;
    bool TRACKING_MAX_PROB = false;
    bool TRACKING_CLICKED = false;
